  ...
  return (
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-4">
                      {/* Thrift Máy tính */}
                      <div className="hidden lg:block flex items-left col-span-1 text-start text-gray-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          ...
          >
              Thrift Shop
                      ...
                      {/* Home Máy tính */}
          <div className="hidden lg:block col-span-2 flex text-gray-600 mt-1">
            <span
            ...
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/shop/men")}
            >
              Men's Wear
            </span>
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/shop/women")}
            >
              Women's Wear
            </span>
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/shop/kid")}
            >
              Kid's Wear
            </span>
            <span
          ...
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            >
              ...
              {/* <span className="absolute top-0 right-0 mt-1 bg-red-700 rounded px-1 text-white text-xs hover:text-gray-200 font-semibold">
                {data.wishListProduct !== null ? data.wishListProduct.length : 0}
              </span> */}
            </div>
      ...
      {/* End Navber Section */}
      <Divider sx={{ height: '100px', mb: '40px' }} />
    </Fragment>
  );
};
