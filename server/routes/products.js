...
router.get("/:pType", productController.getProductByType);
...
// Consignment Routes
router.post("/submit-consignment", upload.array("images", 2), productController.submitConsignment);
router.patch("/approve-consignment/:id", productController.approveConsignment);
